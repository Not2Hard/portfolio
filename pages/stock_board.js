    ...
    <React.Fragment>
      ...
      <div className={classes.mainWrap}>
        ...
        <main className={classes.containerWrap}>
          ...
          I don't have to login or save anything. I can see what is going on in one sight.   <br/>
          </Typography>
          <Typography className={text.paragraph}>
          ...
          <Typography className={text.paragraph}>
          <a href="https://polygon.io/" target="_blank">Polygon.io</a> is the data source for this project. To show the data in beutiful charts <a href="https://www.tradingview.com/" target="_blank">TradingView </a>charts wrere used. I used Polygon.io <a href="https://github.com/polygon-io/tradingview-adapter">TradingView Adapter</a> as an easy way to connect them.<br/>
          </Typography>
          <Typography className={text.paragraph}>
          <a href="https://github.com/sheaivey/react-axios" target="_blank">Axios Component</a> for React with child function callback was utilized in this project to render async requests. <br/>
          </Typography>
          <Typography className={text.paragraph}>
          I used <a href="https://bulma.io/" target="_blank">Bulma</a> css framework for styling.<br/>
          </Typography>
          <Typography className={text.paragraph}>
           <a href="https://github.com/react-grid-layout/react-grid-layout" target="_blank">React-Grid-Layout</a> is a great way to make a grid of elements that are scalable and have drag and drop functionality.<br/>
          </Typography>
          <Typography className={text.paragraph}>
           <a href="https://github.com/maslianok/react-resize-detector" target="_blank">React Resize Detector</a> was used to obtain the size of each chart and save it together with stock name and layout in local storage.<br/>
          </Typography>
